        ...
        ['$stateProvider', '$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide',
            function($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide) {
                ...
                $stateProvider
                    ...
                    .state('app.spm-list-function', {
                        url: '/spm-list-function',
                        templateUrl: 'tpl/spm/list_function.html',
                        controller: 'spmListFunction'
                    })
                    .state('app.spm-test-form', {
                        url: '/spm-test-form',
                        templateUrl: 'tpl/spm/test_form.html',
