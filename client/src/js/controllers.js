...
// signin controller
.controller('SigninFormController', ['$scope', '$http', '$state', 'Employee', function($scope, $http, $state, Employee) {
...
.controller('appCtrl', ['$scope', '$http', '$state', 'Employee', '$rootScope', function($scope, $http, $state, Employee, $rootScope) {
