  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Employee.logUsers.findById() instead.
        "prototype$__findById__logUsers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/employees/:id/logUsers/:fk",
          method: "GET"
        },

        // INTERNAL. Use Employee.logUsers.destroyById() instead.
        "prototype$__destroyById__logUsers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/employees/:id/logUsers/:fk",
        ...
        // INTERNAL. Use Employee.logUsers.updateById() instead.
        "prototype$__updateById__logUsers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/employees/:id/logUsers/:fk",
        ...
        // INTERNAL. Use Employee.logUsers() instead.
        "prototype$__get__logUsers": {
          isArray: true,
          url: urlBase + "/employees/:id/logUsers",
          method: "GET"
        },

        // INTERNAL. Use Employee.logUsers.create() instead.
        "prototype$__create__logUsers": {
          url: urlBase + "/employees/:id/logUsers",
          method: "POST"
        },

        // INTERNAL. Use Employee.logUsers.destroyAll() instead.
        "prototype$__delete__logUsers": {
          url: urlBase + "/employees/:id/logUsers",
          method: "DELETE"
        },

        // INTERNAL. Use Employee.logUsers.count() instead.
        "prototype$__count__logUsers": {
          url: urlBase + "/employees/:id/logUsers/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Employee.logUsers
     * @header lbServices.Employee.logUsers
     * @object
     * @description
     *
     * The object `Employee.logUsers` groups methods
     * manipulating `LogUser` instances related to `Employee`.
     *
     * Call {@link lbServices.Employee#logUsers Employee.logUsers()}
     * to query all related instances.
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `LogUser` object.)
         * </em>
         */
        R.logUsers = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::get::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#count
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         * Counts logUsers of employee.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        R.logUsers.count = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::count::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#create
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         * Creates a new instance in logUsers of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.logUsers.create = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::create::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#createMany
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         ...
         * </em>
         */
        R.logUsers.createMany = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::createMany::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#destroyAll
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         * Deletes all logUsers of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        R.logUsers.destroyAll = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::delete::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#destroyById
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         * Delete a related item by id for logUsers.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for logUsers
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.logUsers.destroyById = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::destroyById::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#findById
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         * Find a related item by id for logUsers.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.logUsers.findById = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::findById::employee::logUsers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Employee.logUsers#updateById
         * @methodOf lbServices.Employee.logUsers
         *
         * @description
         *
         * Update a related item by id for logUsers.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        R.logUsers.updateById = function() {
          var TargetResource = $injector.get("LogUser");
          var action = TargetResource["::updateById::employee::logUsers"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.LogUser
 * @header lbServices.LogUser
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `LogUser` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#create
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/logUsers",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.LogUser#createMany
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#upsert
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#exists
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/logUsers/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.LogUser#findById
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/logUsers/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.LogUser#find
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#findOne
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/logUsers/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.LogUser#updateAll
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/logUsers/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.LogUser#deleteById
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/logUsers/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.LogUser#prototype$updateAttributes
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#createChangeStream
         * @methodOf lbServices.LogUser
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/logUsers/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Employee.logUsers.findById() instead.
        "::findById::employee::logUsers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/employees/:id/logUsers/:fk",
        ...
        // INTERNAL. Use Employee.logUsers.create() instead.
        "::create::employee::logUsers": {
          url: urlBase + "/employees/:id/logUsers",
          method: "POST"
        },

        // INTERNAL. Use Employee.logUsers.createMany() instead.
        "::createMany::employee::logUsers": {
          isArray: true,
          url: urlBase + "/employees/:id/logUsers",
          method: "POST"
        },
        ...
        // INTERNAL. Use Employee.logUsers.destroyAll() instead.
        "::delete::employee::logUsers": {
          url: urlBase + "/employees/:id/logUsers",
          method: "DELETE"
        },

        // INTERNAL. Use Employee.logUsers.count() instead.
        "::count::employee::logUsers": {
          url: urlBase + "/employees/:id/logUsers/count",
          method: "GET"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#updateOrCreate
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#update
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#destroyById
         * @methodOf lbServices.LogUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.LogUser#removeById
         * @methodOf lbServices.LogUser
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.LogUser#modelName
    * @propertyOf lbServices.LogUser
    * @description
    * The name of the model represented by this $resource,
    * i.e. `LogUser`.
    */
